...
import { BlackMarks, ProductHuntIcon, BlueMarks } from '../../Icons';
			...
			<Container>
				...
				<div className="advantages">
					<div className="advantages--item">
						<BlueMarks/>
						<p className="new-section">7 days money back guarantee</p>
					</div>
					
					<div className="advantages--item">
						<BlueMarks/>
						<p className="new-section">Quick onboarding</p>
					</div>
					
					<div className="advantages--item">
						<BlueMarks/>
						<p className="new-section">Cancel anytime</p>
					</div>
				</div>
			</Container>
		</section>
